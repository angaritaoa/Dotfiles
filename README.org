...
Adicionar en ~/etc/default/grub~ los parámetros:
rd.driver.blacklist=nouveau modprobe.blacklist=nouveau nvidia-drm.modeset=1 ipv6.disable=1 intel_iommu=on
...
- Plasma: configurar las preferencias
...
- Flameshot: configurar el comando: flameshot gui
